...
void SessionCaptureCallback_OnSequenceEnd(
    ...
    std::thread sequenceThread(
        &NDKCamera::OnCaptureSequenceEnd,
        static_cast<NDKCamera*>(context),
        session,
        sequenceId,
        frameNumber
 ...
 */
void NDKCamera::OnCaptureSequenceEnd(
    ACameraCaptureSession*, int sequenceId, int64_t
) {
